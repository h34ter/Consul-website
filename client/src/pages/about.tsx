      ...
      <main className="pt-32 pb-20 px-6 md:px-10">
        <div className="max-w-[900px] mx-auto">
          ...
          <motion.h1 
            ...
            className="text-[48px] md:text-[72px] font-bold text-foreground mb-20 text-left tracking-tight"
          >
            About
          </motion.h1>
          ...
          <div className="space-y-16 mb-24">
            ...
            >
              <h2 className="text-[20px] md:text-[24px] font-semibold text-foreground mb-5">
                The Problem We Saw
              </h2>
              <p className="text-[16px] md:text-[17px] font-normal leading-[1.8] text-muted-foreground">
          ...
          <div className="flex flex-col gap-8 mt-32 border-t border-border pt-10">
            <h2 className="text-sm font-mono uppercase tracking-widest text-muted-foreground mb-8">Leadership</h2>
             ...
             <motion.div 
                ...
                className="group relative pb-8 border-b border-border hover:border-[#19A89D]/50 transition-colors duration-500"
             >
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div>
                        <h3 className="text-4xl md:text-6xl font-bold text-foreground mb-3 group-hover:text-[#19A89D] transition-colors duration-500">Hithin Phadarthi</h3>
                        <p className="text-sm font-mono uppercase tracking-widest text-muted-foreground group-hover:text-foreground transition-colors">Founder</p>
                    </div>
                    <div className="mb-1">
                        <a href="mailto:hithin@consul.ong" className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors group/link text-lg">
                            hithin@consul.ong
             ...
             >
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div>
                        <h3 className="text-4xl md:text-6xl font-bold text-foreground mb-3 group-hover:text-[#19A89D] transition-colors duration-500">Sajad Sabah</h3>
                        <p className="text-sm font-mono uppercase tracking-widest text-muted-foreground group-hover:text-foreground transition-colors">Executive Partner</p>
                    </div>
                    <div className="mb-1">
                         <a href="mailto:sajad@consul.ong" className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors group/link text-lg">
                            sajad@consul.ong
                            <ArrowUpRight className="w-4 h-4 opacity-0 group-hover/link:opacity-100 transition-all -translate-y-1 translate-x-1 text-[#19A89D]" />
                        </a>
                    </div>
