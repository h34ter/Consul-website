  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-4 opacity-70 group-hover:opacity-100 transition-opacity">
        <span className="text-sm">{study.emoji}</span>
      ...
      {/* 5. Metrics */}
      <div className="flex items-center gap-3 text-[13px] font-medium text-muted-foreground group-hover:text-primary/90 transition-colors mt-auto">
